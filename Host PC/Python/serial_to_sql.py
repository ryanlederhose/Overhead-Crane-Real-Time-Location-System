...
def main():
    ...
    try:
        con = sql.connect(server, user, password, database, autocommit=True)
...
def read_serial():
    ...
    while True:
        ...
        if readFlag == True:
            ...
            cur.execute("INSERT INTO dbo.positions (crane_id, update_time, x, y, weight) VALUES (%s, getdate(), %s, %s, %s)" %
                        (craneID, posX, posY, averageTrueMass))
